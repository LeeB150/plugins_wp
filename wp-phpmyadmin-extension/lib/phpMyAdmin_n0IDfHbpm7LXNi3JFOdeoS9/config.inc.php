...
$cfg['blowfish_secret']					= 'A1\\9`kl[(#wC[[&3LWv=zN\',py/KYh{B' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_n0IDfHbpm7LXNi3JFOdeoS9/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
...
$cfg['Servers'][$i]['SignonURL']    = 'https://test.megabits.es/wp-admin/?rand=13253436&goto_wp_phpmyadmin=1';
$cfg['Servers'][$i]['LogoutURL']    = 'https://test.megabits.es/wp-admin/?rand=97688836&pma_logout=1';
